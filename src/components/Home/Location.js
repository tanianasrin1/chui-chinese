  ...
  return (
    <div className="mb-12">
      <div className="container-sk">
        ...
        {/* <p className="text-center lg:text-base text-sm lg:w-3/4 w-full mx-auto mt-2 font-semibold">
          Create a section dedicated to seasonal ingredients and recipes,
          providing inspiration for cooking with fresh, seasonal produce.
        </p> */}
