  ...
  return (
    <>
      <div className="">
        <div className="mt-6">
          <Image
            className=" object-cover lg:h-20 md:h-32 h-16 lg:w-20  md:w-32  w-16 rounded-full mx-auto"
            src="/images/test.jpg"
            width={50}
            height={50}
        ...
        <p className="lg:text-lg md:text-base text-sm lg:leading-[28px]  text-center lg:w-8/12 lg:mt-7 md:mt-10 mt-4  mx-auto w-full">
        ...
        <p className="lg:text-[22px] md:text-lg text-base  text-center font-semibold lg:mt-7 mt-3 text-black-theme">
          Cody Fisher
        </p>
      </div>
    </>
