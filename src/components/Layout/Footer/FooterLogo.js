    ...
    <div className="  flex lg:flex-row flex-col lg:gap-12 gap-6 lg:py-8  py-4">
      <div className="lg:w-4/12 w-full ">
        <div className="w-[100px]  h-[88px] relative">
          {/* src={${variantData?.image}?t=${new Date().getTime()}} */}
          <Image src={"/images/noimage.png"} alt="Institution logo" fill />
          {/* <Image    src={`${siteSetting?.data?.logo}?t=${new Date().getTime()} || "/images/noimage.png"`} alt="Institution logo" fill /> */}
        </div>
